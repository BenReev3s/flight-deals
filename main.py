...
print("After fetching Google Sheet data")

flight_search = FlightSearch()
data_manager = DataManager()
notification_manager = NotificationManager()
print("After creating NotificationManager")

customer_data = data_manager.get_customer_emails()
customer_emails = [user["whatIsYourEmail?"] for user in customer_data["users"]]

print("Before flight search loop")
    ...
    if item["iataCode"] != "":
        ...
        if flight:
            ...
            if float(flight.price) < float(lowest_price):
                ...
                if customer_emails:
                    notification_manager.send_email(customer_emails,flight.origin_airport, flight.destination_airport, flight.out_date, flight.return_date, flight.price)
            else:
                pass
        else:
